...
//Saves on writing "QuizContract." repetitively
import com.erik.sqlitepreview.QuizContract.*;
...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    //If you update app change DATABASE_VERSION
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String SQL_CREATE_QUESTIONS_TABLE = "CREATE TABLE " +
                ...
                //Makes each row have a unique ID, so ID doesn't get repeated
    ...
    //Boilerplate future proofing code to create a new database with new versions of the app
    //Only have to use this method if the app is in production
    @Override
    ...
    public ArrayList<Question> getQuestions(String difficulty) {
        ...
        if (c.moveToFirst()) {
            //Used to move to first entry if it exists, then queries entry and fills question object with data
            do {
